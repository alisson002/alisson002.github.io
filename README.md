...
O objetivo deste projeto é detectar e contar o número de faces em imagens e videos. O código deve colocar uma caixa (bounding box) nos rostos detectados e contá-los, através de suas coordenadas. 
